              ...
              <div className="w-full hover:bg-gray-200 cursor-pointer p-2 relative">
                ...
                >
                  ...
                  <div className="w-full flex flex-col">
                    <p className="text-sm truncate min-w-30 max-w-50">
                      {task.name}
                    </p>
                ...
                <div className="flex gap-0.5 items-center justify-start">
                  <Button
                    ...
                    onClick={(e) => {
                      ...
                      handleUpdateRule(task.id, { start_date: today });
                  ...
                  <Button
                    ...
                    onClick={(e) => {
                      ...
                      handleUpdateRule(task.id, { start_date: tomorrow });
                      setOpenContextMenu(false);
                    }}
                  >
                  ...
                  <Button
                    ...
                    onClick={(e) => {
                      ...
                      handleUpdateRule(task.id, { start_date: nextWeek });
                      setOpenContextMenu(false);
                    }}
                  >
                        ...
                        <ContextMenuSub>
                          ...
                          <ContextMenuSubContent sideOffset={10}>
                            {list.sections.map((section) => {
                              const sectionItem = sectionIndex[section];
