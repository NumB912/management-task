...
export const routes: Route[] = [
  ...
  {
    matcher: "/api/tags/:tagId/onlyMe",
    chain: [await verifyToken(), await checkOwnerTag()],
  },
  ...
  { matcher: "/api/user/me/notification", chain: [await verifyToken()] },
  {
    matcher: "/api/lists",
  ...
  {
    matcher: "/api/lists/:listId/sections/:sectionId/tasks",
    chain: [
      await verifyToken(),
      await checkPermission({
        "can edit": ["DELETE", "GET", "PATCH", "POST", "PUT"],
  ...
  {
    matcher: "/api/lists/:listId/tasks",
    chain: [
      await verifyToken(),
      await checkPermission({
        "can edit": ["DELETE", "GET", "PATCH", "POST", "PUT"],
  ...
  {
    matcher: "/api/lists/:listId/members/inviteStatus",
    chain: [await verifyToken()],
  },
  {
  ...
  { matcher: "/api/lists/:listId/members", chain: [await verifyToken()] },
  {
    ...
    chain: [await verifyToken("register_token", "x-register")],
  },
  {
    matcher: "/api/tasks/today",
    chain: [await verifyToken()],
  },
  {
    matcher: "/api/tasks/upComming",
    chain: [await verifyToken()],
  },
  {
    matcher: "/api/tasks/:taskId",
    chain: [
      await verifyToken(),
      await checkPermissionTask({
        "can edit": ["DELETE", "GET", "PATCH", "POST", "PUT"],
        "read only": ["GET"],
      }),
    ],
  ...
  {
    matcher: "/api/tasks/:taskId/status",
    chain: [
      await verifyToken(),
      await checkPermissionTask({
        "can edit": ["DELETE", "GET", "PATCH", "POST", "PUT"],
  ...
  {
    matcher: "/api/sections/:sectionId",
    chain: [
      await verifyToken(),
      await checkPermissionSection({
        "can edit": ["DELETE", "GET", "PATCH", "POST", "PUT"],
        "read only": ["GET"],
      }),
    ],
